...
contract TestConsensusCommitment {
    ...
    function fromFrameworkCommitment(Commitment.CommitmentStruct memory frameworkCommitment)
        public
        pure
        returns (ConsensusCommitment.ConsensusCommitmentStruct memory)
    {
        return ConsensusCommitment.fromFrameworkCommitment(frameworkCommitment);
    }

    function appAttributes(Commitment.CommitmentStruct memory frameworkCommitment)
        public
        pure
        returns (ConsensusCommitment.AppAttributes memory)
    {

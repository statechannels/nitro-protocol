...
contract TestCommitment {
    ...
    function isPreFundSetup(Commitment.CommitmentStruct memory _commitment)
        public
        pure
        returns (bool)
    {
    ...
    function isPostFundSetup(Commitment.CommitmentStruct memory _commitment)
        public
        pure
        returns (bool)
    {
    ...
    function channelId(Commitment.CommitmentStruct memory _commitment)
        public
        pure
        returns (address)
    {
